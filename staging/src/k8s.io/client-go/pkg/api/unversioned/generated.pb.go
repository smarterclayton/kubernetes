...
func init() {
	...
	proto.RegisterType((*GroupKind)(nil), "k8s.io.client-go.pkg.api.schema.GroupKind")
	proto.RegisterType((*GroupResource)(nil), "k8s.io.client-go.pkg.api.schema.GroupResource")
	proto.RegisterType((*GroupVersion)(nil), "k8s.io.client-go.pkg.api.schema.GroupVersion")
	proto.RegisterType((*GroupVersionForDiscovery)(nil), "k8s.io.client-go.pkg.api.unversioned.GroupVersionForDiscovery")
	proto.RegisterType((*GroupVersionKind)(nil), "k8s.io.client-go.pkg.api.schema.GroupVersionKind")
	proto.RegisterType((*GroupVersionResource)(nil), "k8s.io.client-go.pkg.api.schema.GroupVersionResource")
