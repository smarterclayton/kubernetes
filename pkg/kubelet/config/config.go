...
// SourceChannel creates or returns a config source channel.  The channel
// only accepts PodUpdates
func (c *PodConfig) SourceChannel(source string) chan interface{} {
	return c.mux.SourceChannel(source)
}
...
func (s *podStorage) Merge(source string, change interface{}) error {
	...
	if s.incremental {
		...
		s.updates <- kubelet.PodUpdate{s.Object().([]kubelet.Pod), kubelet.SET}
	}
...
func (s *podStorage) Object() interface{} {
	s.podLock.RLock()
