...
func TestRESTMapper(t *testing.T) {
	...
	if gvk, err := latest.GroupOrDie(internal.GroupName).RESTMapper.KindFor(unversioned.GroupVersion{Group: internal.SchemeGroupVersion.Group}.WithResource("replicationcontrollers")); err != nil || gvk != rcGVK {
