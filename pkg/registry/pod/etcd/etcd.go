...
func NewREST(h tools.EtcdHelper, factory pod.BoundPodFactory) (*REST, *BindingREST) {
	...
	store := &etcdgeneric.Etcd{
		...
		KeyRootFunc: func(ctx api.Context) string {
			return etcdgeneric.NamespaceKeyRootFunc(ctx, "/registry/pods")
		},
		KeyFunc: func(ctx api.Context, name string) (string, error) {
			return etcdgeneric.NamespaceKeyFunc(ctx, "/registry/pods", name)
		},
...
// BindingREST binds pods to nodes.
...
func (r *BindingREST) setPodHostTo(ctx api.Context, podID, oldMachine, machine string) (finalPod *api.Pod, err error) {
	...
	err = r.store.Helper.AtomicUpdate(podKey, &api.Pod{}, func(obj runtime.Object) (runtime.Object, error) {
		pod, ok := obj.(*api.Pod)
		if !ok {
...
func (r *BindingREST) assignPod(ctx api.Context, podID string, machine string) error {
	...
	err = r.store.Helper.AtomicUpdate(contKey, &api.BoundPods{}, func(in runtime.Object) (runtime.Object, error) {
...
func (h *podLifecycle) AfterUpdate(obj runtime.Object) error {
	...
	return h.AtomicUpdate(containerKey, &api.BoundPods{}, func(in runtime.Object) (runtime.Object, error) {
