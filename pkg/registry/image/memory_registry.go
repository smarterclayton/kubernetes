...
type MemoryRegistry struct {
	imageData           map[string]api.Image
	imageRepositoryData map[string]api.ImageRepository
...
func (r *MemoryRegistry) ListImages(selector labels.Selector) ([]api.Image, error) {
	result := []api.Image{}
...
func (r *MemoryRegistry) GetImage(imageID string) (*api.Image, error) {
...
func (r *MemoryRegistry) CreateImage(image api.Image) error {
...
func (r *MemoryRegistry) ListImageRepositories(selector labels.Selector) ([]api.ImageRepository, error) {
	result := []api.ImageRepository{}
...
func (r *MemoryRegistry) GetImageRepository(repositoryID string) (*api.ImageRepository, error) {
...
func (r *MemoryRegistry) CreateImageRepository(repository api.ImageRepository) error {
...
func (r *MemoryRegistry) UpdateImageRepository(repository api.ImageRepository) error {
